...
// Mieten page images conversions
const CONVERSIONS = [
  { input: 'mieten_1.jpg', output: 'mieten_1.webp', width: null, height: null },
  { input: 'mieten_2.jpg', output: 'mieten_2.webp', width: null, height: null },
];
...
async function main() {
  console.log('Optimizing Mieten page images...\n');
  for (const conv of CONVERSIONS) {
    await convertImage(conv);
  }
  console.log('\n✅ All Mieten page images converted!');
}
